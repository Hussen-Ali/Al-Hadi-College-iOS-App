...
//        } else {
            if !GIDSignIn.sharedInstance.hasPreviousSignIn() && accessToken == "nil" {
                ...
                self.window = window
                window.makeKeyAndVisible()} else if GIDSignIn.sharedInstance.hasPreviousSignIn() && accessToken == "nil"{
